...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/Source_Katya) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/Source_Katya) /Kt \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/Source_Katya)\n [𝗦𝗼𝗨𝗿𝗖𝗲 𝗞𝗮𝗧𝘆𝗔](https://t.me/Source_Katya)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/Source_Katya) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/Miika3"),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/Source_Katya) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/Source_Katya) \n ※[These Features AI Based](https://t.me/Source_Katya)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="fv_av"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/Source_Katya"),
                ],
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/Ve_G4"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("Source_Katya"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🔱 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع نينجا من هن : @Source_Katya **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
