...
@app.on_message(
    filters.command(["مميزات","مميزات كاتيا"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس كاتيا ميوزك\n
⩹━★⊷⌯⌞ 𝗦𝗼𝗨𝗿𝗖𝗲 ⏣ 𝗞𝗮𝗧𝘆𝗔 ⌝⌯⊶★━⩺

★قايمه مميزات سورس نينجا 
